...
class TestMarkdownAndENML(unittest.TestCase):
    ...
    def testParseENML(self):  # {{{
        ...
        self.assertEqual(lines[7] , u'<en-todo checked="false"/>')
        self.assertEqual(lines[8] , u'チェックボックス')
        self.assertEqual(lines[9] , u'<en-todo checked="true"/>')
        self.assertEqual(lines[10], u'チェック済み')
        self.assertEqual(lines[11], u'1.数字付１')
        self.assertEqual(lines[12], u'2.同じく２')
        self.assertEqual(lines[13], u'3.おまけに３')
        self.assertEqual(lines[14], u'1.list2-1')
        self.assertEqual(lines[15], u'2.list2-2')
        self.assertEqual(lines[16], u'> インデント')
        self.assertEqual(lines[17], u'> インデント２')
        self.assertEqual(lines[18], u'> > ２重インデント')
        self.assertEqual(lines[19], u'> > ２重インデント２')
        self.assertEqual(lines[20], u'    def haruhi(self):')
        self.assertEqual(lines[21], u'        pass')
        self.assertEqual(lines[22], u'### asuka.langley')
