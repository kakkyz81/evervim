...
class TestMarkdownAndENML(unittest.TestCase):
    ...
    def testParseENML(self):  # {{{
        ...
        self.assertEqual(lines[4] , u'')
        self.assertEqual(lines[5] , u'* リスト１')
        self.assertEqual(lines[6] , u'* りすと２')
        self.assertEqual(lines[7] , u'* リスト３')
        self.assertEqual(lines[8] , u'')
        self.assertEqual(lines[9] , u'<en-todo checked="false"/>')
        self.assertEqual(lines[10], u'チェックボックス')
        self.assertEqual(lines[11], u'<en-todo checked="true"/>')
        self.assertEqual(lines[12], u'チェック済み')
        self.assertEqual(lines[13], u'')
        self.assertEqual(lines[14], u'1.数字付１')
        self.assertEqual(lines[15], u'2.同じく２')
        self.assertEqual(lines[16], u'3.おまけに３')
        self.assertEqual(lines[17], u'')
        self.assertEqual(lines[18], u'')
        self.assertEqual(lines[19], u'1.list2-1')
        self.assertEqual(lines[20], u'2.list2-2')
        self.assertEqual(lines[21], u'')
        self.assertEqual(lines[22], u'> インデント')
        self.assertEqual(lines[23], u'> インデント２')
        self.assertEqual(lines[24], u'')
        self.assertEqual(lines[25], u'> > ２重インデント')
        self.assertEqual(lines[26], u'> > ２重インデント２')
        self.assertEqual(lines[27], u'')
        self.assertEqual(lines[28], u'')
        self.assertEqual(lines[29], u'    def haruhi(self):')
        self.assertEqual(lines[30], u'        pass')
